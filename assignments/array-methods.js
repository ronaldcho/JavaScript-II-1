...
let fullName = [];
let first_lastName = runners.forEach(function(elem){
...
let ticketPriceTotal = runners.reduce((donateTotal, donateAmount)=>{
	return donateTotal + donateAmount;
}, 0);
console.log(ticketPriceTotal);
